...
namespace _11_Image_Processing
{
    ...
    {
        public static readonly RoutedCommand Edit = new RoutedCommand(Strings.Edit,typeof(Commands),new InputGestureCollection() { new KeyGesture(Key.E, ModifierKeys.Control)});
